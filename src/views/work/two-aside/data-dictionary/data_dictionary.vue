<template>
  <div class="data_dictionary">
    <div class="data_dictionary_tit">
      <div class="tit_l">数据字典</div>
      <div class="tit_r">
        <div @click="openSet" title="设置">
          <i class="iconfont icon-setting"></i>
        </div>
      </div>
    </div>
    <div class="data_dictionary_tree">
    ...
    <div class="data_dictionary_list">
      <template v-for="item,i in listData">
        <div class="item" @click="handleClick(item)" :class="{'active':item.isActive}">
          <el-tooltip class="item" effect="dark" :content="item.label" placement="top">
            <span class="con">{{item.label}}</span>
          </el-tooltip>
    ...
    <setDialog
      ref="setDialog"
      :dialog="setDialogDialog"
      @closeDialog="setDialogDialog = false"
      @clickSubmit="setDialogSubmit"
    ></setDialog>
  </div>
</template>

<script>
import setDialog from "./components/set.dialog";
export default {
  components: {
    setDialog
  },
  ...
  methods: {
    ...
    openTab(data) {
      ...
      page = {
        ...
        title: `数据字典`,
        icon: "iconfont daiosshujuzidian",
        zdId: data.id //字典id，用于切换不同的数据字典详情
      };
